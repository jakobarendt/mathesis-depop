...
-   **add that it is not actually based on the standard WGS84, but rather on the WGS84 for computer usage (where x and y axes are interchanged) see sf documentation for a brief explanation; OGC:CRS84**
