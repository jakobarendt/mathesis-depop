...
+ - einzelner dummy für ländlich und nicht nicht notwendig, kein Interesse + - FEs noch: country-zeit oder zeit (ersteres wahrscheinlich besser) + - $\delta \cdot \text{year}$ trend faktor + - am besten log-lin model (oder alternativ first differences, wenn zu viele rausfallen weil log(0)), ansonsten beobachtungen mit 0 rausnehmen, dann halt unbalanced panel (aber das ist ok, sofern die 0 random ist) - 2-part-modell als sonstige Lösung
