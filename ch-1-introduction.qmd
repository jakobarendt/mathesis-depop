...
Similarly, the proofs that demonstrate how a multitude of human activity is the cause of modern-day climate change through the continuous emissions of greenhouse gases have never been less clear.
While this shows that we have relatively good knowledge of what humans are capable of doing to the climate, the opposite direction seems less clear: we still stand a lot to gain from a better understanding of what the climate and its changes are doing to humans and human societies and economies, not least as this varies greatly with the specific population, area and societal and socioeconomic circumstances considered.
...
First, the population size of a municipality heavily determines its political influence and leverage.
Consider that, for example, many of the most populous cities end up becoming capitals that house the most powerful political institutions of their nations.
...
Second, the population size of a municipality matters also for its economic constitution: even in a theoretical scenario without economies of scale and where economic output of a country is evenly distributed across all its inhabitants such that its empirical GDP per capita exhibits a uniform distribution, total economic production of a populous city would be much higher than that of a small town.
...
Such an understanding is essential for informed policymaking to further develop adequate and well-targeted policies that effectively strengthen mitigation of, adaptation to and resilience against climate change, ensuring sustainable population and economic development.
One concrete exemplary use-case where insights on the climate-population relationship could prove helpful is how urbanisation and city growth also increase humans' vulnerability towards climate change.
...
\[**TODO** Differentiators to other, already published, literature:\]
...
-   Unique in the geographical and economic area it covers, many studies seemed to have focused more on large cities or developing countries [@chung-etal-2022-review-climate-imigration-cities]. Using data from European sources, where independent statistical and meteorological institutions responsible for collecting the data underlying this study have been, at least historically, comparably strong and reliable.
-   To my knowledge, no one has so far pursued such a climate-related analysis with this exact population data set, particular contribution with geographical area it investigates (Europe) and the spatial level of detail.
    -   In the literature that I have come across, the time distance between a panel's periods was often a year. The decennial data used here may provide a useful addition to the range of methodologies, especially when considering the philosophy behind long-differences modelling frameworks.
...
The remainder of this thesis paper is organised as follows: in [chapter @sec-ConceptFramework], I lay out the conceptual framework behind my research question and discuss supporting literature.
In particular, I consider investigations that use econometric methodology to identify effects of climate on socioeconomic outcomes and that identify mechanisms likely underlying the climate-population relationship.
Then a chapter on the methodology used in my investigation follows ([-@sec-Methodology]), along with a chapter on the data sets ([-@sec-Data]).
@Sec-Results lays out the results of my work and [chapter @sec-Conclusion] concludes.
Appendices with further details on the population ([-@sec-AppxPopData]) and weather ([-@sec-AppxWeatData]) data are also provided.
...
- check whether I can find a rate of deurbanisation/ruralisation (the flip side of urbanisation) for Europe, otherwise just consider the change of the share of people living in rural areas
- Mention what it adds to the literature:
  - High spatial resolution
  - Long inter-period distances but still panel
  - Demographic effects in Europe
