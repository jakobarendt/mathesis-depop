...
**(mention that** $\mathbf{c}_{i \tau}$ is a description of the weather during $\tau$ and give an example such as for the mean **??**; also think about **first, second, third etc statistical moment**)
...
-   FEs noch: country-zeit oder zeit (ersteres wahrscheinlich besser) --\> dann aber noch trend sinnvoll?
    dann aber auf jeden Fall keine Country-FEs mehr benötigt?
