...
In other words, climate is the parametrisation of the joint distributions $\psi ( \cdot )$, based on which certain potential states of weather could realise during time period $\tau$ and at place $i$.
...
Going back to the previous example, people that adapt to a higher likelihood of sunburns are those that expect high UV-exposure and put on sunscreen and, therefore, reduce their likelihood of sunburns (which is the direct effect in this example).
[TODO: explain estimation strategies to account for adaptation, also consider @merel-gammans-2021-climate-econometrics-lr-adaptation]

[^ch-3-methodology-1]: While direct effects can also be substantiated for very short time periods, belief effects and changes thereof are often traceable only over the longer run, with data sets covering longer time periods.
...
\[Open questions for this sub-chapter:\]

-   @Anna Lena: too close to @hsiang-2016-climate-econometrics?
