...
-   Panel model: Frequency-identification-trade-off - longer time period better for inferring climate vs. control and treatment population better comparable (identification more reliable for shorter periods)
...
-   Country-Time-FEs (generally captures more, i.e. better control in theory, but try Country-Time-trend if the Country-Time-FEs capture too much)
