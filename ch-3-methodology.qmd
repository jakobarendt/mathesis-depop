...
Socioeconomic impacts of climate: direct vs. belief effects.
\[TODO further elaborate on that\].
...
To be able to surely associate any differences in units' outcomes to differences in climate, all of their other differentiating characteristics that influence the outcome have to be known and controlled for.[^ch-3-methodology-1]
...
This has the advantage that they are much less prone to confounding due to unobserved or non-measurable characteristics also influencing outcomes,[^ch-3-methodology-2] but it comes at the cost that climate and/or changes thereof are harder to determine.
...
[^ch-3-methodology-1]: This results from the *unit homogeneity assumption* further discussed in the context of the identification problem and the Rubin Causal Model in @sec-MethodologySubsecIdentificationProblem.

[^ch-3-methodology-2]: They rely on a weaker form of the *unit homogeneity assumption*, the *marginal treatment comparability assumption*.
