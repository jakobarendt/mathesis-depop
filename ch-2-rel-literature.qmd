...
For example, if a defined population experiences no migration, and has new children at the same rate as deaths, it does neither grow nor decline--it is stable.
...
Third, they can be subject to conscious decisions by individuals or society, or they are the direct consequences of the circumstances, the environment or the events they find themselves exposed towards.
For example, the decision to migrate could be one imposed relatively forceful by a natural disaster or one considerately taken with longer-term view and justified by living preferences.
**\[Fourth point here?\]**

When investigating the relationship between climate and growth and spatial distribution of population, the aforementioned aspects make it hard to perfectly distil all the underlying causal chains from climate to population, infer about their interactions and understand how they might combine to form the overall effect.
As a researcher, one then typically has to make the decision to either look at individual links of these causal chains in isolation or to consider the aggregate relationship.
Even though the econometric analysis in this thesis aims to do the latter, the following describes a few of the causal chains that are likely to drive the climate-population relationship.
